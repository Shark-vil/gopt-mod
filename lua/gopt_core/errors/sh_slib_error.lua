if SERVER then
	util.AddNetworkString('gopt_error_slib_library')

	hook.Add('PlayerSpawn', 'GOPT_SLIB_ERROR', function(ply)
		...
		timer.Simple(5, function()
			...
			net.Start('gopt_error_slib_library')
			net.Send(ply)
		end)
	end)
...
|___/____|___|___/ |_|\_|\___/ |_|   |_| \___/ \___/|_|\_|___/ 
	...
	net.Receive('gopt_error_slib_library', function()
		local MainMenu = vgui.Create('DFrame')
		MainMenu:SetPos(ScrW() / 2 - 500 / 2, ScrH() / 2 - 250 / 2)
		MainMenu:SetSize(500, 250)
		MainMenu:SetTitle('GOpt - Error slib library')
		...
		maleImage:SetImage('gopt/vgui/missing_slib.png')
